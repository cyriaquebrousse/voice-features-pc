  ...
  public static void main(String[] argv) {
    if (argv.length == 3) {
      try {
        ...
        System.err.println("Please provide a well formatted number for the time stretching factor. See Synopsis.");
      } catch (UnsupportedAudioFileException e) {
        System.err.println("Unsupported audio file, please check if the input is 16bit 44.1kHz MONO PCM wav.");
      } catch (IOException e) {
        System.err.println("IO error, could not read from, or write to the audio file, does it exist?");
      }
    } else {
      System.err.println("Please provide exactly 3 arguments, see Synopsis.");
    }
  }
...
//  }
  ...
  public static void startCli(String source,String target,double cents) throws UnsupportedAudioFileException, IOException{
